package com.gifthub.server.User.Jwt;

import com.gifthub.server.User.DAO.RedisDAO;
import com.gifthub.server.User.Repository.TokenRepository;
...
public class JwtTokenProvider {
    ...
    private static final long REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60L * 24 * 30 * 4 * 12;
